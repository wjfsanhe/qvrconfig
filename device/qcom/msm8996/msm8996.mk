...
PRODUCT_COPY_FILES += device/qcom/msm8996/whitelistedapps.xml:system/etc/whitelistedapps.xml \
	...
	#ADD by zhoumingliang  for QDCM Display color calibration
PRODUCT_COPY_FILES += device/qcom/msm8996/qdcm_calib_data_Sharp_4k_dsc_dsi_panel.xml:system/etc/qdcm_calib_data_Sharp_4k_dsc_dsi_panel.xml
...
PRODUCT_PACKAGES += fan
PRODUCT_PACKAGES += qvrconfig
...
#add follow line for write wifi and bt mac address by wangfajie @20160906
PRODUCT_PACKAGES += writeMacAddress
...
LOCAL_PATH := zprojects/$(LCT_PROJECT_NAME)
include $(LOCAL_PATH)/LCTPreConfig_$(LCT_PROJECT_NAME).mk
PRODUCT_PROPERTY_OVERRIDES += \
...
PRODUCT_COPY_FILES += \
    device/qcom/msm8996/freqtemp.sh:system/etc/freqtemp.sh
